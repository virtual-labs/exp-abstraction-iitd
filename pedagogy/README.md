...
<b> Experiment|  <b> 1. Introduction to Interface
...
#### Experimentation
The lab will focus on the process of develop java programming code including the syntax and methods used for implementing
interface in java programs.
#### Learn from failure
...
:--|:--|:--|:-:
1.| Student will be able to: <br>describe the structure of interface using java<br> | Understand| Describe
2.| Student will be able to: <br>identify different components of a java program<br> | Apply| Identify
3.| Student will be able to: <br>develop a basic java program to display any text meassage | Create| Develop
...
:--|:--|:--|:--
1.| Student will be able to describe the structure of interface using java. | Select the text editor for your java program. | Q • What type of variable can be defined in an interface? <br>a) public static<br>b) private final<br>c) public final<br><b>d) static final</b>
2.| Student will be able to identify different components of a java program.| Demonstrate the working of how to implement interface in program. | Q • All methods must be implemented of an interface. <br><b>a) True </b><br>b) False
3.| Student will be able to develop a basic java program to display any text meassage.| Construct a java program for displaying given output. | Q •	What does an interface contain? <br>a) Method definition <br><b>b) Method declaration</b><br>c) Method declaration and definition<br>d) Method name
